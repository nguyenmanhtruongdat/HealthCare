...
import com.example.healthcare.databinding.ActivityAppointmentRequiredDetailBinding;
import com.example.healthcare.model.BookingDoctorInformation;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.storage.FirebaseStorage;
import com.google.firebase.storage.StorageReference;

public class AppointmentRequiredDetailActivity extends AppCompatActivity {
    private final FirebaseAuth mAuth = FirebaseAuth.getInstance();
    private ActivityAppointmentRequiredDetailBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAppointmentRequiredDetailBinding.inflate(getLayoutInflater());
        ...
        binding.backBtn.setOnClickListener(view -> {
            Intent intent1 = new Intent(AppointmentRequiredDetailActivity.this, AppointmentRequiredActivity.class);
        ...
        binding.signOutBtn.setOnClickListener(view1 -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(AppointmentRequiredDetailActivity.this, R.style.CustomDialog);
            ...
            builder.setPositiveButton("Yes", (dialog, id) -> {
                ...
                mAuth.signOut();
                Intent intent1 = new Intent(AppointmentRequiredDetailActivity.this, LoginActivity.class);
                startActivity(intent1);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
            });
